...
ffc$gage_start_date = "1979-10-01" # can change the start date, or use defaults
...
## Passing your own timeseries data

```{r}

# requires a comid and your own timeseries

ffc$step_one_functional_flow_results(timeseries = ts, comid = comid, token = "your_token_value", output_folder = "C:\path\to\where\outputs\should\go")
```
