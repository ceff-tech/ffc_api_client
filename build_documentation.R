current_version <- "0.9.8.3"  # it'd be nice to have this just find the latest file in the folder instead
...
devtools::build_site(path = "ffcAPIClient/", examples = FALSE, preview = FALSE)
